...
class Producer {
    ...
    public static void main(String[] args) throws Exception {
    	 ...
    	 *  ActiveMQ.
    	 */
        JmsConnectionFactory factory = new JmsConnectionFactory("failover:(amqp://192.168.208.5:5672,amqp://192.168.208.4:5682)");
        ...
        if(args.length > 0 && args[0].equalsIgnoreCase("QUEUE")) {        	
        	destination = session.createQueue("AFN_11111111111111111111_InQueue");
